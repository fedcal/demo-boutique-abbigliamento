...
hero:
  name: "Demo Boutique Abbigliamento"
  text: "Template Angular 21 SSR"
  tagline: "Sito vetrina pre-configurato con dati mock realistici per PMI italiane"
  actions:
    - theme: brand
      text: Demo live
      link: https://boutique-abbigliamento.demo.federicocalo.dev
    - theme: alt
      text: Source code
      link: https://github.com/fedcal/federico-demo-boutique-abbigliamento
...
features:
  ...
  - icon: 📊
    ...
    details: Dati Italia 2026 (menu, listini, orari, prezzi medi) curati per il verticale Boutique Abbigliamento.
  - icon: 🚀
...
Questo repository contiene il template **Angular 21 SSR** per un sito web professionale per **Boutique Abbigliamento** in Italia.
...
Il mercato italiano delle PMI per **Boutique Abbigliamento** ha caratteristiche specifiche:
...
```bash
npm run build
npm run serve:ssr:boutique-abbigliamento
# → http://localhost:4000
```
...
- [GitHub repo](https://github.com/fedcal/federico-demo-boutique-abbigliamento)
