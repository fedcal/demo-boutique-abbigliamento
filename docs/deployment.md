...
URL: `https://boutique-abbigliamento.demo.federicocalo.dev`
...
2. Aggiungi custom domain in Vercel Dashboard:
   - Settings > Domains > Add `boutique-abbigliamento.demo.federicocalo.dev`
...
- Output directory: `dist/boutique-abbigliamento/browser`
...
URL: `https://fedcal.github.io/federico-demo-boutique-abbigliamento/`
...
- `base: /federico-demo-boutique-abbigliamento/` (subdirectory GH Pages)
- `cleanUrls: true`
...
Per usare `boutique-abbigliamento-docs.federicocalo.dev` invece del subdirectory:

1. Cloudflare DNS aggiungi CNAME:
   ```
   boutique-abbigliamento-docs    CNAME    fedcal.github.io    (proxy OFF)
   ```
2. Repo Settings > Pages > Custom domain: `boutique-abbigliamento-docs.federicocalo.dev`
